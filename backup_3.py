...
# functioning code to generate reports for all the accounts in the .env file and make a pdf out of it
        ...
        try:
            ...
            for exec in executions:
                ...
                if exec["execType"] == "Trade":
                    trading_fees += fee
                    # Add to total volume for trades
...
def generate_report_for_account(account):
    ...
    Equity In BTC: {equity_in_btc} BTC
    ...
    report += "\n5. Today's Fees:\n------------------\n"
    Funding Fees: {fees['funding_fees']}
    Trading Fees: {fees['trading_fees']}
